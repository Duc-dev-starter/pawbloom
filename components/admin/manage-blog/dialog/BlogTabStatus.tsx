...
const BlogTabStatus = ({ selectedTab, setSelectedTab }: { selectedTab: string, setSelectedTab: React.Dispatch<SetStateAction<Blog["status"]>> }) => {
