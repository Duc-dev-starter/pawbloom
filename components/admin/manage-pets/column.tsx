...
import PetMenuDropdown from "@/app/admin/manage-pets/pet-menu-actions"
...
export const getColumns = ({ onEdit, onDelete }: ColumnProps): ColumnDef<Pet>[] => [
	{
		accessorKey: "name",
	...
	},
	{
		...
		cell: ({ getValue }) => {
			const value = getValue() as string
			return (
				<span>{value === "Large" ? "Lớn" : value === "Medium" ? "Trung bình" : value === "Small" ? "Nhỏ" : value}</span>
			)
		},
	},
	{
	...
	},
	{
		...
		cell: ({ row }) => {
			...
			return <PetMenuDropdown pet={pet} onEdit={onEdit} onDelete={onDelete} />
		},
	},
]
